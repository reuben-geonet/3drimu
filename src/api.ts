...
const FALLBACK_GEOJSON: RimuGeoJson = {
  ...
  features: [
    {
      type: "Feature",
      geometry: { type: "Point", coordinates: [175.6172, -40.3523] },
      properties: {
        key: "locality:example-ridge",
        locality: "example-ridge",
        sitecode: "XRID",
        tags: ["demo", "seismic", "mains12"]
      }
    },
    {
      type: "Feature",
      geometry: { type: "Point", coordinates: [172.8078, -43.2651] },
      properties: {
        key: "locality:sample-bay",
        locality: "sample-bay",
        sitecode: "XSBY",
        tags: ["demo", "gnss", "solar"]
      }
    },
    {
      type: "Feature",
      geometry: { type: "Point", coordinates: [168.8763, -45.0367] },
      properties: {
        key: "locality:mock-peak",
        locality: "mock-peak",
        sitecode: "XMPK",
        tags: ["demo", "building", "timing"]
      }
    }
  ]
};
